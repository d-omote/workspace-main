...
class FaceCropping:
    ...
    def __setFaceOrganCoordList(self):
        ...
        rightEyebrowCoordList = [max(0, cropRightEyebrowTop - test), cropRightEyebrowBottom + test, max(0, cropRightEyebrowLeft - test), cropRightEyebrowRight + test]
        ...
        rightEyeCoordList = [max(0, cropRightEyeTop - test), cropRightEyeBottom + test, max(0, cropRightEyeLeft - test), cropRightEyeRight + test]
        ...
        leftEyebrowCoordList = [max(0, cropLeftEyebrowTop - test), cropLeftEyebrowBottom + test, max(0, cropLeftEyebrowLeft -test), cropLeftEyebrowRight + test]
        ...
        leftEyeCoordList = [max(0, cropLeftEyeTop - test), cropLeftEyeBottom + test, max(0, cropLeftEyeLeft - test), cropLeftEyeRight + test]
        ...
        mouseCoordList = [max(0, cropMouseTop - test), cropMouseBottom + test, max(0, cropMouseLeft - test), cropMouseRight + test]
        ...
        noseCoordList = [max(0, round(nose[0][1]) - test), round(nose[1][1] + 10) + test, max(0, round(self.__landmark[31][0] - 10) - test), round(self.__landmark[35][0] + 10) + test]
    ...
    def draw_landmark(self):
        for points in self.__landmark:
            cv2.drawMarker(self.__img, (points[0], points[1]), (0, 255, 0), markerSize=11, thickness=3)
        return self.__img
    ...
    def get_eyebrow_right_mask_img(self):
        ...
        """
        points = np.array([self.__landmark[17] - new_start_point + [-30, 30], 
                           self.__landmark[18] - new_start_point + [-30, -15], 
                           self.__landmark[19] - new_start_point + [0, -20], 
                           self.__landmark[20] - new_start_point + [30, -20], 
                           self.__landmark[21] - new_start_point + [30, 30]])
        img = self.draw_convex_hull(img, points)

        cv2.imwrite("./result/mask/mask_eyebrow_right.jpg", img)

        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)

        cv2.imwrite("./result/mask/filter_mask_eyebrow_right.jpg", img)
    ...
    def get_eye_right_mask_img(self):
        ...
        points = np.array([self.__landmark[36] - new_start_point + [-40, 0], 
                           self.__landmark[37] - new_start_point + [-30, -30], 
                           self.__landmark[38] - new_start_point + [30, -30], 
                           self.__landmark[39] - new_start_point + [30, 0], 
                           self.__landmark[40] - new_start_point + [30, 30], 
                           self.__landmark[41] - new_start_point + [-30, 30]])
        img = self.draw_convex_hull(img, points)

        cv2.imwrite("./result/mask/mask_eye_right.jpg", img)

        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        
        cv2.imwrite("./result/mask/filter_mask_eye_right.jpg", img)
    ...
    def get_eyebrow_left_mask_img(self):
        ...
        points = np.array([self.__landmark[22] - new_start_point + [-30, 30], 
                           self.__landmark[23] - new_start_point + [-30, -15], 
                           self.__landmark[24] - new_start_point + [0, -20], 
                           self.__landmark[25] - new_start_point + [30, -20], 
                           self.__landmark[26] - new_start_point + [30, 30]])
        img = self.draw_convex_hull(img, points)

        cv2.imwrite("./result/mask/mask_eyebrow_left.jpg", img)

        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        
        cv2.imwrite("./result/mask/filter_mask_eyebrow_left.jpg", img)
    ...
    def get_eye_left_mask_img(self):
        ...
        points = np.array([self.__landmark[42] - new_start_point + [-40, 0], 
                           self.__landmark[43] - new_start_point + [-30, -30], 
                           self.__landmark[44] - new_start_point + [30, -30], 
                           self.__landmark[45] - new_start_point + [30, 0], 
                           self.__landmark[46] - new_start_point + [30, 30], 
                           self.__landmark[47] - new_start_point + [-30, 30]])
        img = self.draw_convex_hull(img, points)

        cv2.imwrite("./result/mask/mask_eye_left.jpg", img)

        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        
        cv2.imwrite("./result/mask/filter_mask_eye_left.jpg", img)
    ...
    def get_mouse_mask_img(self):
        ...
        cv2.imwrite("./result/mask/mask_mouse.jpg", img)

        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        
        cv2.imwrite("./result/mask/filter_mask_mouse.jpg", img)
    ...
    def get_nose_mask_img(self):
        ...
        cv2.imwrite("./result/mask/mask_nose.jpg", img)

        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        img = cv2.GaussianBlur(img, (7, 7), 0)
        
        cv2.imwrite("./result/mask/filter_mask_nose.jpg", img)
    ...
    def get_mask_img_list(self):
        ...
        """
        i = 0
        for img in mask_img_list:
            cv2.imwrite(("mask" + str(i) + ".jpg"), img)
            i += 1
        """
